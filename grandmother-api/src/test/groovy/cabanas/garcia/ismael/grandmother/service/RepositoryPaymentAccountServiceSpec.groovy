...
class RepositoryPaymentAccountServiceSpec extends Specification{
    ...
    def "should return payment transactions in ascending order by date for given account on a year and month"(){
        given: "a given account with transactions"
            ...
            PaymentTransaction aguaPayment = new PaymentTransaction(amount: TEN_THOUSAND, chargeType: getAguaPayment(), dateOfMovement: parse("2016-01-01 00:00:00.0"))
            PaymentTransaction gasPayment = new PaymentTransaction(amount: TWENTY_THOUSAND, chargeType: getGasPayment(), dateOfMovement: parse("2016-01-20 00:00:00.0"))
